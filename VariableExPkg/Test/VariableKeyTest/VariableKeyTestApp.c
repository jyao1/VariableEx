...
EDKII_VARIABLE_EX_PROTOCOL            *mVariable;
...
{
  return mVariable->GetVariableEx(VariableName, VendorGuid, Attributes, AttributesEx, DataSize, Data);
}
...
{
  return mVariable->SetVariableEx(VariableName, VendorGuid, Attributes, AttributesEx, DataSize, Data);
}
